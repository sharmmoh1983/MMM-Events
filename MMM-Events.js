...
Log.log("socketNotificationReceived EVENTS_RESULT");
...
notificationReceived: function(notification, payload, sender) {
 Log.log("In events module notificationReceived",notification); 

		if (notification === "SHOW_EVENTS") {
Log.log("In events module",this.hidden);
                        this.sendSocketNotification('GET_EVENTS', this.url);
